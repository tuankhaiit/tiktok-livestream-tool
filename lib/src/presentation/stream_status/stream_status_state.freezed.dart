...
class _$_StreamStatusState implements _StreamStatusState {
  ...
  @override
  String toString() {
    return 'StreamStatusState(roomId: $roomId, uniqueId: $uniqueId, nickname: $nickname, avatar: $avatar, status: $status, memberNum: $memberNum, serverOnline: $serverOnline)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, roomId, uniqueId, nickname,
      avatar, status, memberNum, serverOnline);
