...
class _$_RoomModel implements _RoomModel {
  ...
  @override
  String toString() {
    return 'RoomModel(roomId: $roomId, userId: $userId, uniqueId: $uniqueId, nickname: $nickname, avatar: $avatar, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, roomId, userId, uniqueId, nickname, avatar, status);
...
abstract class _RoomModel implements RoomModel {
  const factory _RoomModel(
      ...
      required final String status}) = _$_RoomModel;
